...
filepath = "models/7CARRL-1593404593-800-0.8615048875706075-.h5"
...
class DQNAgent:
    ...
    def train(self, terminal_state, eps):
        #train main model every step during episode

        #start training only if there are no more episodes with human input
        if eps <= human_input_eps:
            return
